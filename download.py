...
with open(redImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/red/red-{}.jpg {}".format(redFileCounter, line))
...
with open(orangeImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/orange/orange-{}.jpg {}".format(orangeFileCounter, line))
...
with open(yellowImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/yellow/yellow-{}.jpg {}".format(yellowFileCounter, line))
...
with open(greenImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/green/green-{}.jpg {}".format(greenFileCounter, line))
...
with open(blueImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/blue/blue-{}.jpg {}".format(blueFileCounter, line))
...
with open(purpleImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/purple/purple-{}.jpg {}".format(purpleFileCounter, line))
...
with open(greyImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/grey/grey-{}.jpg {}".format(greyFileCounter, line))
...
with open(whiteImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/white/white-{}.jpg {}".format(whiteFileCounter, line))
...
with open(blackImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/black/black-{}.jpg {}".format(blackFileCounter, line))
...
with open(brownImageList, 'r') as f:
    for line in f:
        os.system("wget --connect-timeout=10 -q -O imageset/brown/brown-{}.jpg {}".format(brownFileCounter, line))
